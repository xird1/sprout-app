...
export class EmployeeCalculate extends Component {
                    ...
                    <div className="form-row">
                        ...
                        {this.state.employeeTypeId === 1 ?
                            <div className='form-group col-md-6'>
                                ...
                                <input min="0" type='number' className='form-control' id='inputAbsentDays4' onChange={this.handleChange.bind(this)} value={this.state.absentDays} name="absentDays" placeholder='Absent Days' />
                            </div> :
                            <div className='form-group col-md-6'>
                                <label htmlFor='inputWorkDays4'>Worked Days: </label>
                                <input min="0" type='number' className='form-control' id='inputWorkDays4' onChange={this.handleChange.bind(this)} value={this.state.workedDays} name="workedDays" placeholder='Worked Days' />
                            </div>
                        }
                    </div>
    ...
    async calculateSalary() {
        ...
        if (this.state.workedDays < 0 || this.state.absentDays < 0) {
            alert("Must be equal or greater than 0")
            this.setState({
                loadingCalculate: false
            });
            return;
